...
export default function AuthClient() {
  ...
  return (
    <main className="dark relative min-h-dvh w-full overflow-x-hidden bg-neutral-950 text-neutral-50 selection:bg-primary selection:text-primary-foreground antialiased lg:grid lg:grid-cols-12">
      <Link
        href="/"
        className="fixed left-4 top-4 z-50 inline-flex h-9 max-w-[calc(100vw-2rem)] items-center gap-2 truncate rounded-full border border-neutral-800/80 bg-neutral-950/85 px-3 text-[11px] font-medium text-neutral-400 shadow-lg shadow-black/20 backdrop-blur-md transition hover:border-neutral-700 hover:text-neutral-200 sm:left-6 sm:top-6 sm:px-4 sm:text-xs lg:left-8 lg:top-8"
      >
        <ArrowLeft className="h-3.5 w-3.5 shrink-0" />
        <span className="truncate">Return Home</span>
      </Link>

      <section className="relative hidden flex-col justify-between overflow-hidden border-r border-neutral-800/70 bg-neutral-900 p-12 lg:col-span-5 lg:flex xl:col-span-4">
        ...
        <div className="relative z-10 mt-20 xl:mt-24">
          <Image
        ...
        <div className="relative z-10 border-t border-neutral-800/60 pt-6">
          <p className="text-xs text-neutral-500">
            Protected local marketplace. © HireCore.
          </p>
        </div>
      </section>
        ...
        <div className="flex w-full max-w-152 flex-col justify-center">
          <div className="w-full overflow-hidden rounded-3xl border-0 bg-neutral-950 p-5 shadow-none sm:p-8 lg:border lg:border-neutral-800/70 lg:bg-neutral-900/35 lg:p-10 lg:shadow-2xl lg:shadow-black/30 xl:p-12">
            <div className="space-y-8">
              ...
              <div className="grid grid-cols-2 rounded-lg bg-neutral-900 p-1 text-xs font-medium ring-1 ring-neutral-800/80">
                <button
                  type="button"
              ...
              <Button
                type="button"
                variant="outline"
                className="h-11 w-full rounded-lg border-neutral-800 bg-neutral-900 text-xs font-medium text-neutral-200 hover:bg-neutral-800/80 hover:text-neutral-100"
                onClick={() => {
              ...
              <div className="relative flex items-center justify-center">
                ...
                <span className="relative bg-neutral-950 px-3 text-[10px] font-bold uppercase tracking-widest text-neutral-500 lg:bg-[#101010]">
                  or use email
                </span>
              </div>
                    ...
                    >
                        ...
                        <div className="min-w-0 space-y-1.5">
                          ...
                          <div className="relative min-w-0">
                            ...
                            <Input
                              ...
                              className="h-10 w-full min-w-0 rounded-lg border-neutral-800 bg-neutral-900/50 pl-9 text-xs text-neutral-200 placeholder:text-neutral-600 focus-visible:ring-1 focus-visible:ring-neutral-700"
                              value={fullName}
                              onChange={(event) =>
                      ...
                      <div className="space-y-2 pt-2">
                        <div className="flex min-w-0 flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                          ...
                          <span className="w-fit max-w-full truncate rounded border border-primary/15 bg-primary/10 px-2 py-0.5 text-[11px] font-medium text-primary">
                        ...
                        <div className="grid min-w-0 gap-3 sm:grid-cols-2">
                          {accountTypeCards.map((card) => {
                            ...
                            const isSelected = accountTypes.includes(
                              card.value,
                            );
                            ...
                            return (
                              <button
                                ...
                                className={
                                  isSelected
                                    ? "relative flex min-w-0 flex-col items-start rounded-xl border border-primary/50 bg-primary/5 p-4 text-left transition-all"
                                    : "relative flex min-w-0 flex-col items-start rounded-xl border border-neutral-800 bg-neutral-900/35 p-4 text-left transition-all hover:bg-neutral-900/60"
                                }
                              >
                                <div className="flex w-full min-w-0 items-center justify-between gap-3">
                                  <div
                                    className={
                                      isSelected
                                        ? "shrink-0 rounded-md bg-primary/10 p-1.5 text-primary"
                                        : "shrink-0 rounded-md bg-neutral-800 p-1.5 text-neutral-400"
                                    }
                                  >
                                  ...
                                  <div
                                    className={
                                      isSelected
                                        ? "flex h-4 w-4 shrink-0 items-center justify-center rounded-md border border-primary bg-primary text-neutral-950"
                                        : "flex h-4 w-4 shrink-0 items-center justify-center rounded-md border border-neutral-700"
                                    }
                                  >
                                    {isSelected && (
                ...
                <div className="min-w-0 space-y-1.5">
                  ...
                  <div className="relative min-w-0">
                    ...
                    <Input
                      ...
                      placeholder="••••••••"
                      className="h-10 w-full min-w-0 rounded-lg border-neutral-800 bg-neutral-900/50 pl-9 pr-10 text-xs text-neutral-200 placeholder:text-neutral-600 focus-visible:ring-1 focus-visible:ring-neutral-700"
                      value={password}
