      ...
      <section className="relative z-10 px-4 pb-24 pt-32 sm:px-6 lg:pt-40">
        <div className="mx-auto max-w-5xl">
          ...
          <form onSubmit={handleSearch} className="mx-auto mt-10 max-w-3xl">
            <div className="flex items-center gap-3 rounded-2xl border border-border bg-card/80 p-2 shadow-(--shadow-card) backdrop-blur-2xl transition focus-within:border-primary/40 focus-within:shadow-(--glow-primary)">
...
function TaskCard({ job, employerTrust, employerName }: TaskCardProps) {
  ...
  return (
    <Link
      href={`/tasks/${job.id}`}
      className="group relative flex flex-col justify-between overflow-hidden rounded-2xl border border-border bg-card/80 p-5 shadow-(--shadow-card) backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:border-primary/40 hover:shadow-(--shadow-lift)"
    >
      {/* Top row: icon + badge */}
...
function TaskCardSkeleton() {
  return (
    <div
      ...
      className="flex min-h-100 flex-col justify-between rounded-2xl border border-border bg-card/80 p-5 shadow-(--shadow-card)"
    >
      <div>
...
function EmptyState() {
  return (
    <div className="rounded-2xl border border-border bg-card/80 p-16 text-center shadow-(--shadow-card)">
